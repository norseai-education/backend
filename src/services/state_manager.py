...
class StateManager:
    ...
    def default_state(self):
        def_state = {"classification": None, 
                     ...
                     "lesson_state": {'START_LESSON': 'In Progress', 'GIVE_PROBLEM': 'Not Done','PROBLEM_WALKTHROUGH': 'Not Done','GIVE_PROBLEM': 'Not Done', 'PROBLEM_WALKTHROUGH': 'Not Done','GIVE_PROBLEM': 'Not Done', 'PROBLEM_WALKTHROUGH': 'Not Done','END_LESSON': 'Not Done'}, 
                     "messages": [], 
