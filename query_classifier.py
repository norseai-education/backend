...
class ClassifierModel:
    ...
    def build_node(self, state: State):
        utils.log("Going through classifier node...", logger, 2)
        ...
        utils.log(f"Classification result: --{classification.classification}--", logger, 2)
        utils.log("Classifier node complete", logger, 2)
